...
})({"kh6co":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "11a1e81efebf489f";
"use strict";
...
},{}],"3trjY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _censocustodyJs = require("./censocustody.js");
parcelHelpers.exportAll(_censocustodyJs, exports);

},{"./censocustody.js":"eWzTk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eWzTk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "CensoWallet", ()=>CensoWallet);
var _web3Js = require("@solana/web3.js");
var _bs58 = require("bs58");
var _bs58Default = parcelHelpers.interopDefault(_bs58);
var _uuid = require("uuid");
var _eventemitter3 = require("eventemitter3");
var Buffer = require("8b4db1b2bb86d18f").Buffer;
const DEFAULT_SIGNATURE_BUFFER = Buffer.alloc((0, _web3Js.SIGNATURE_LENGTH_IN_BYTES)).fill(0);
class CensoWallet extends (0, _eventemitter3.EventEmitter) {
    constructor(){
        super();
        ...
        this.handleWalletMessage = (data)=>{
            ...
            if (data.type == "connected") {
                ...
                if (!data.error) {
                    ...
                    if ((_a = data.connected) === null || _a === void 0 ? void 0 : _a.publicKey) this._publicKey = new (0, _web3Js.PublicKey)(data.connected.publicKey);
                }
            } else if ([
                "sendTransaction",
    ...
    async sendTransaction(transaction, connection, options) {
        try {
            ...
            const transactionIdentifier = (0, _uuid.v4)();
    ...
    buildTransaction(pendingTransaction) {
        let message = (0, _web3Js.Message).from(Buffer.from(Uint8Array.from(window.atob(pendingTransaction.message), (c)=>c.charCodeAt(0))));
        return (0, _web3Js.Transaction).populate(message, Array.from({
            ...
            return (0, _bs58Default.default).encode(sigPubkeyPair ? Buffer.from(Uint8Array.from(window.atob(sigPubkeyPair.signature), (c)=>c.charCodeAt(0))) : DEFAULT_SIGNATURE_BUFFER);
        }));
    }
    verifyCanSignRequests(transactions) {
        transactions.forEach((transaction)=>{
            if (transaction.signatures.some((s)=>s.signature != null)) throw new Error("Censo does not support this signing mode");
        });
    }
    signOneTransaction(transaction, transactionIdentifier = (0, _uuid.v4)()) {
        const wallet = this._wallet;
        if (!wallet) throw new Error("Not Connected");
        const instructions = this.instructionsToSerializableInstructions(transaction.instructions);
        this._pendingTransactions[transactionIdentifier] = null;
    ...
    signMultipleTransactions(transactions) {
        ...
        const serializedTransactions = transactions.map((t)=>{
            return {
                ...
                transactionIdentifier: (0, _uuid.v4)()
            };
        });
...
},{"8b4db1b2bb86d18f":"fCgem","@solana/web3.js":"5JBKN","bs58":"2QNCL","uuid":"j4KJi","eventemitter3":"3fnfh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2QNCL":[function(require,module,exports) {
var basex = require("9df75fcde058ed88");
var ALPHABET = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";
module.exports = basex(ALPHABET);

},{"9df75fcde058ed88":"llfOg"}],"llfOg":[function(require,module,exports) {
"use strict";
...
// @ts-ignore
var _Buffer = require("456aa833c4f81373").Buffer;
...
},{"456aa833c4f81373":"eW7r9"}]},["kh6co"], null, "parcelRequirebe40")

//# sourceMappingURL=esm.febf489f.js.map
